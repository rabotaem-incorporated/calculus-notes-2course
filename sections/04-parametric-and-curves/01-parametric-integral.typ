...
#proof[
  Очевидно по теореме и предыдущему следствию.
]
...
#proof[
  ...
  $ (F(t_0 + h) - F(t_0)) / h = 1/h (integral_X f(x, t_o + h) dif mu(x) - integral_X f(x, t_0) dif mu(x)) = \ = integral_X underbrace((f(x, t_o + h) - f(x, t_0))/h, := g(x, h)) dif mu(x). $
