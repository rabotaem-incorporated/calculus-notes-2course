...
#notice[
  ...
  2. $nabla Phi_1 (a), ..., nabla Phi_m (a)$ --- строки матицы $Phi' (a)$, то есть они линейно назависимы $<==>$ $rk Phi' (a) = m$ (максимально возможный).
...
#proof[
  ...
  По теореме о неявной функции#rf("th-implicit-fn") существуют $W$ --- окрестность $b$ и $g: W --> RR^m$, непрерывно дифференцируемая, такие, что $Phi(y, g(y)) = 0$ для любого $y in W$.
...
#proof[
  ...
  $Phi(x) = 0$ --- компакт, поэтому наибольшее и наименьшее значения сущесвуют#rf("th-weierstrass").
