...
#proof[
  ...
  $h'(y) = f'(y, g(y)) dot mat(E; g'(y)) = f'_y (y, g(y)) + f'_z (y, g(y)) g'_y = f'_y (a) + f'_z (a) g'(b)$. Здесь $f_x$ означает, что от $f$ остались только столбцы, соответствующие переменным $x$, а остальное занулилось.
