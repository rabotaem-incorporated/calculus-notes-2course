...
#proof[
  Доказательство конструктивное, поэтому вместе с ним прилагается конкретный способ такую систему построить. Такой процесс называется "_ортогонализацией Грамма-Шмидта_".
...
#th(name: "о наилучшем приближении")[
  $A in H$ --- непустое, замкнутое, выпуклое; $x in H$. Тогда существует единственный элемент наилучшего приближения.
]
