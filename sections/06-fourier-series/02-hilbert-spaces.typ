...
#th(name: "ортогонализация Грамма-Шмидта")[
...
#proof[
  Доказательство конструктивное, поэтому вместе с ним прилагается конкретный способ такую систему построить. Такой процесс называется "_ортогонализацей Грамма-Шмидта_".
...
#proof[
  ...
  $
  --- а это все многочлены. Надо доказать, что замыкание всех многочленов это $L^2$. Мы докажем только для многочленов из пунктов 1-3, да и то творчески, сославшись на теорему из будущего. Надо понять, что любую функцию из $L^2$ можно приблизить многочленом. Берем $eps > 0$ и $f in L^2$. Тогда найдется $g in L^2$ непрерывная такая, что $norm(f - g)_2 < eps$. По теореме Вейерштрасса (докажем позже#rf("weierstrass2"), хотя на практиках уже), любую непрерывную функцию на отрезке можно равномерно приблизить многочленом. Тогда существует $h$ --- многочлен такой, что $norm(f - h)_oo < eps$. Знаем
  $
...
#th(name: "о наилучшем приближении")[
  $A subset H$ --- непустое, замкнутое, выпуклое; $x in H$. Тогда сущесвует единственный элемент наилучшего приближения.
]
