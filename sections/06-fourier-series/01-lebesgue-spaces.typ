...
#def[
  ...
  $
  На классах эквивалентности это --- норма.
]
...
#example(name: "важный частный случай")[
  ...
  Все функции в таком пространстве --- последовательности. Классы эквивалентности здесьс не нужны, потому что мера любой точки равна $1$.
...
#def[
  Если $(X, rho)$ --- метрическое пространство, и $A subset X$, то $A$ называют _всюду плонрым_, если $Cl A = X$.
]
