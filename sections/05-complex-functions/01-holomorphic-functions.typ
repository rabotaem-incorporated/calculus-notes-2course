...
#proof[
  $f(z) dif z$ --- локально точная, значит, у нее локально есть первообразная у каждой точки. Что у формы, что у функции --- это одно и тоже, $F'$. Тогда $F' = f$, следовательно $F$ голоморфно в окрестности $z_0$. Значит#rf("hfn-analytical-props", "derivative-hfn"), $f$ --- голоморфна в окрестности $z_0$.
]
...
#proof[
  ...
  - "$2 ==> 3$": очевидно.
  - "$3 ==> 1$": очевидно.
  - "$4 <==> 5$": первообразная формы $f(z) dif z$ и функции $f$ --- одно и тоже#rf("form-antiderivative-hfn-antiderivative").
