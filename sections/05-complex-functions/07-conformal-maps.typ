...
#proof[
    Пусть $f: [alpha, beta] --> CC$, и $gamma(alpha) = a$. 
    $
        (f(gamma(z)))' = f' (gamma(z)) dot gamma'(z),\
        (f compose gamma)'(alpha) = f'(a) dot gamma'(alpha).
    $
    Вектор $gamma'(alpha)$ повернулся на $arg f'(a)$. А это и есть направление касательной в точке. Значит обе касательные повернуться одинаково, и угол сохраниться.
]
