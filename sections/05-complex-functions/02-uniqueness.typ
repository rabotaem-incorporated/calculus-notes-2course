...
#proof[
  Пусть $g equiv.not 0$. Берем $z_0 in Omega$ такое, что $g(z_0) != 0$. Тогда $f(z_0) = 0$, и $f(z) != 0$ в $circle(U)_(z_0)$ по предыдущей теореме. Тогда $g equiv 0$ в $circle(U)_(z_0)$, так как $f dot g equiv 0$.
]
