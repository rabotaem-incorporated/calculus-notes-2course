...
#th(name: "неравенство Чебышева (не путать с неравентсвом Чебышева из теорвера, где оно называется \"неравенство Маркова\", а неравенство Чебышева там другое)", label: "chebyshev-inequality")[
