...
#th(name: "принцип Каратеодори/Кавальери")[
...
#notice[
    ...
    - $tilde(Pp)(C) := {x in X: nu C_x > 0}$ всегда измеримо. Пэтому вместо $X$ в интеграле можно написать множество $tilde(Pp)(С)$. Просто надо его посчитать.
]
